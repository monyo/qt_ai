...
| **特殊池輪動** | 1Y alpha > 100% 的大贏家獨立追蹤：回落 -10% 賣出、反彈 +10% 買回（回測 +102.5% vs 持有 +33.1%） |
...
| **特殊池輪動** | 1Y alpha > 100% 的大贏家進入特殊池，回落 -10% 自動輪動出場，低點反彈 +10% 再買回；待辦清單列出 Firstrade Stop-Market 掛單價 |
